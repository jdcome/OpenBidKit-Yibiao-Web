...
export const HEADING_NUMBERING_FORMAT_OPTIONS = [
  { value: 'native', label: '按标题样式自动编号（1~6 级）' },
...
// 表格单元格专属对齐：在常规水平对齐之外，额外提供「水平+垂直居中」。
// docx 单元格默认垂直靠上，此选项同时落 <w:vAlign val="center"/> 与段落水平居中。
// 仅用于表格首行/首列/其余单元格，不进 ALIGNMENT_OPTIONS（标题/正文等场景无垂直语义）。
export const TABLE_CELL_VERTICAL_CENTER_ALIGN = '水平+垂直居中' as const;

export const TABLE_CELL_ALIGNMENT_OPTIONS = [
  '居中对齐',
